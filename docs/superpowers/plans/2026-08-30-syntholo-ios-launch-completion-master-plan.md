...
- [x] Run the suite on the current iOS simulator. September 6 revision `4aea165` passed all 487 canonical tests on iPhone 17 Pro / iOS 26.5 with zero failure, skip, cancellation, or runtime retry. Its executable source matches the September 5 iOS 17.5 pass; only documentation differs. All 47 current-runtime XCTest bundles were independently verified. See `docs/quality/2026-09-06-current-runtime-baseline.md`.
  - Later September 6 runner follow-up: a fresh review found a real cancellation/child-cleanup defect. The corrected runner and strengthened harness at `c25791f` passed another complete 487/487 current-runtime invocation with zero failure, skip, cancellation, or runtime retry; all 47 bundles were independently verified. See `docs/quality/2026-09-06-test-runner-cancellation.md`. The earlier iOS 17.5 run covers unchanged app code, not this new runner or CI's pinned toolchain.
